...
@NoArgsConstructor
@AllArgsConstructor
public class ResVulkSaleInventoryDTO {
    private List<Inventory> inventory;

    public static ResVulkSaleInventoryDTO from(List<InventoryEntity> inventoryEntity) {
        return ResVulkSaleInventoryDTO.builder()
