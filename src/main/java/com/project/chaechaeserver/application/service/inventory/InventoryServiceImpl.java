...
public class InventoryServiceImpl implements InventoryService {
    ...
    public ResCreateInventoryPostDTO createInventory(ReqCreateInventoryDTO request) {
        ...
        ProductsEntity product = productsRepository.findById(request.getInventory().getProductId())
        ...
        return ResCreateInventoryPostDTO.of(product.getId(), savedInventory.getId(),
