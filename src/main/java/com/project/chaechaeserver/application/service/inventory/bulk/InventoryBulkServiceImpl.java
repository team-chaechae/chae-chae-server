...
public class InventoryBulkServiceImpl implements InventoryBulkService {
    ...
    public ResBulkCreateInventoryPostDTO createInventory(ReqBulkCreateInventoryDTO dto) {
        List<Long> productIds = dto.getInventory()
            .stream().map(ReqBulkCreateInventoryDTO.Inventory::getProductId)
            .toList();

        List<Integer> quantities = dto.getInventory()
            .stream().map(ReqBulkCreateInventoryDTO.Inventory::getQuantity)
            .toList();
    ...
    public ResUpdateInventoryDTO modifyInventory(ReqUpdateInventoryDTO dto) {
        List<Long> productIds = dto.getInventory()
            .stream().map(ReqUpdateInventoryDTO.Inventory::getProductId)
            .toList();

        List<Integer> newQuantities = dto.getInventory()
            .stream().map(ReqUpdateInventoryDTO.Inventory::getQuantity)
            .toList();
    ...
    public ResBulkSaleInventoryDTO decreaseInventoryForWarehouseShipment(ReqUpdateInventoryDTO dto) {
        ...
        List<Long> productIds = dto.getInventory()
            .stream()
            .map(ReqUpdateInventoryDTO.Inventory::getProductId)
            .toList();

        List<Integer> quantities = dto.getInventory()
            .stream()
            .map(ReqUpdateInventoryDTO.Inventory::getQuantity)
            .toList();
